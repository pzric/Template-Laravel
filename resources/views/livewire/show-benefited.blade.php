<div class="w-full overflow-x-hidden border-t flex flex-col">
    <div class="container mx-auto px-4 sm:px-8">
        <div class="text-right my-8">
            <a href="{{route('benefited.create')}}" class="text-sm bg-green-500 hover:bg-green-700 text-white py-3 px-8 rounded focus:outline-none focus:shadow-outline">
                ...
                <table class="min-w-full leading-normal">
                    <thead>
                        <tr>
                            ...
                            <th wire:click="order('area')" class="text-center cursor-pointer px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                                Area
                            </th>
                            <th wire:click="order('country_origin')" class="text-center cursor-pointer px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                                Pais
                            </th>
                    ...
                    <tbody>
                      @if ($benefiteds->count())
                      @foreach ($benefiteds as $benefited)
                      <tr>
                          ...
                          <td class="text-center border-b border-gray-200 bg-white text-sm">
                              <div class="ml-2">
                                  <a class="text-sm bg-yellow-500 hover:bg-yellow-700 text-white py-1 px-2 rounded focus:outline-none focus:shadow-outline" href="{{route('benefited.edit', $benefited)}}">
                                      Modificar
                                  </a>
                              </div>
                          </td>
                          <td class="border-b border-gray-200 bg-white text-sm">
                              <form action="{{route('benefited.destroy', $benefited)}}" method="POST">
                                  @csrf
                                  @method('delete')
