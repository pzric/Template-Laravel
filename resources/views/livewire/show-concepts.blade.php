<div class="w-full overflow-x-hidden border-t flex flex-col">
    <div class="container mx-auto px-4 sm:px-8">
        <div class="text-right my-8">
            <a href="{{route('concept.create')}}" class="text-sm bg-green-500 hover:bg-green-700 text-white py-3 px-8 rounded focus:outline-none focus:shadow-outline">
                    ...
                    <tbody>
                      ...
                      <tr>
                          ...
                          <td class="text-center border-b border-gray-200 bg-white text-sm">
                              <div class="ml-2">
                                  <a class="text-sm bg-yellow-500 hover:bg-yellow-700 text-white py-1 px-2 rounded focus:outline-none focus:shadow-outline" href="{{route('concept.edit', $concept)}}">
                                      Modificar
                                  </a>
                              </div>
                          </td>
